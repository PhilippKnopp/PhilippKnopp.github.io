...
function enemyPlanMove (enemy) {
    ...
    for (var s = 0; s < game.scene.scenes[0].children.list.length; s++) {
        if (game.scene.scenes[0].children.list[s] instanceof Enemy) {
            console.log(game.scene.scenes[0].children.list[s]);
        }
    }
