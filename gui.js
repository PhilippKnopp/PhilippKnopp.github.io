function guiBuilder(_this) {
    ...
    Info2 = _this.add.text(InfoName.getBottomRight().x, Info1.getBottomLeft().y+15, "", { fontFamily: "Verdana" , color: '#dddddd', lineSpacing: 12 });
    Info2.showMessage = function (text) {
        Info2.setText(text);
        Info2.setPosition(InfoName.getBottomRight().x, Info1.getBottomLeft().y+15);
    };
